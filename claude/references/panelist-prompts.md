...
Copy the relevant block into each panelist prompt (Agent call or Codex `exec` argument). Replace `{{BRIEF}}` with the Round 0 brief. Replace peer content in Rounds 2–3.
